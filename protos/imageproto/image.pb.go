...
func (x *Sign) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *Sign) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_image_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x3e, 0x0a, 0x04,
	0x53, 0x69, 0x67, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x28, 0x09, 0x52, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x65, 0x0a, 0x0e,
	...
	,
}
...
var file_image_proto_goTypes = []interface{}{
	...
	(*Sign)(nil),           // 2: imageproto.Sign
	(*TransferStatus)(nil), // 3: imageproto.TransferStatus
}
var file_image_proto_depIdxs = []int32{
	...
	2, // 2: imageproto.ImageTransfer.SignUp:input_type -> imageproto.Sign
	2, // 3: imageproto.ImageTransfer.SignIn:input_type -> imageproto.Sign
	3, // 4: imageproto.ImageTransfer.SendImage:output_type -> imageproto.TransferStatus
	3, // 5: imageproto.ImageTransfer.SignUp:output_type -> imageproto.TransferStatus
	3, // 6: imageproto.ImageTransfer.SignIn:output_type -> imageproto.TransferStatus
...
type ImageTransferClient interface {
	...
	SignUp(ctx context.Context, in *Sign, opts ...grpc.CallOption) (*TransferStatus, error)
	SignIn(ctx context.Context, in *Sign, opts ...grpc.CallOption) (*TransferStatus, error)
}
...
func (c *imageTransferClient) SignUp(ctx context.Context, in *Sign, opts ...grpc.CallOption) (*TransferStatus, error) {
	out := new(TransferStatus)
	err := c.cc.Invoke(ctx, "/imageproto.ImageTransfer/SignUp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *imageTransferClient) SignIn(ctx context.Context, in *Sign, opts ...grpc.CallOption) (*TransferStatus, error) {
	out := new(TransferStatus)
	err := c.cc.Invoke(ctx, "/imageproto.ImageTransfer/SignIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImageTransferServer interface {
	...
	SignUp(context.Context, *Sign) (*TransferStatus, error)
	SignIn(context.Context, *Sign) (*TransferStatus, error)
}
...
func (*UnimplementedImageTransferServer) SignUp(context.Context, *Sign) (*TransferStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUp not implemented")
}
func (*UnimplementedImageTransferServer) SignIn(context.Context, *Sign) (*TransferStatus, error) {
...
func _ImageTransfer_SignUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Sign)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImageTransferServer).SignUp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/imageproto.ImageTransfer/SignUp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageTransferServer).SignUp(ctx, req.(*Sign))
	}
	return interceptor(ctx, in, info, handler)
}

func _ImageTransfer_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Sign)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImageTransferServer).SignIn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/imageproto.ImageTransfer/SignIn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageTransferServer).SignIn(ctx, req.(*Sign))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ImageTransfer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SignUp",
			Handler:    _ImageTransfer_SignUp_Handler,
		},
		{
			MethodName: "SignIn",
			Handler:    _ImageTransfer_SignIn_Handler,
		},
	},
